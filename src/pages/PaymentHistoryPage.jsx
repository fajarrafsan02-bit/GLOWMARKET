...
import { Receipt, Clock, CheckCircle, XCircle, ExternalLink, MessageCircle } from "lucide-react";
                                    ...
                                    <div className="flex flex-col items-end gap-3">
                                        ...
                                        <div className="flex gap-2">
                                            ...
                                            <button
                                                ...
                                                className="inline-flex items-center gap-1 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg text-sm font-semibold hover:bg-gray-50 transition"
                                            >
