...
export default function ProductDetailReviews({ reviews, reviewCount }) {
    return (
        <div className="mt-3 sm:mt-5">
            <div className="flex items-center justify-between mb-2">
                ...
                {reviews.length > 0 && (
                    <span className="text-[9px] sm:text-[10px] uppercase tracking-[0.1em] text-gray-400">
                        {reviewCount} reviews
                    </span>
                )}
            </div>
            ...
            {reviews.length > 0 ? (
                <div className="space-y-2">
                    {reviews.slice(0, 2).map((review) => (
                        <div
                            key={review.id}
                            className="border border-gray-200 dark:border-gray-800 p-2.5 sm:p-3.5 rounded-lg"
                        >
