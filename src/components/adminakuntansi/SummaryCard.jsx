...
export default function SummaryCard({ icon: IconComponent, label, value, accent = "amber" }) {
    const styles = {
        amber: {
        ...
        <div className="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-3 sm:p-4">
            <div className="flex items-start justify-between gap-2 sm:gap-3">
                <div className="min-w-0 pr-1">
                    ...
                    <p className="mt-1 sm:mt-1.5 text-[11px] sm:text-base font-bold text-gray-900 dark:text-white tabular-nums truncate" title={formatPrice(value)}>
                        {formatPrice(value)}
                    </p>
                </div>
